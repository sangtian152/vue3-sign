...
export declare const buildProps: <O extends { [K in keyof O]: O[K] extends BuildPropReturn<any, any, any, any, any> ? O[K] : [O[K]] extends NativePropType ? O[K] : O[K] extends BuildPropOption<infer T, infer V, infer C, infer D extends BuildPropType<infer T, infer V, infer C>, infer R> ? D extends BuildPropType<T, V, C> ? BuildPropOption<T, V, C, D, R> : never : never; }>(props: O) => { [K_1 in keyof O]: O[K_1] extends {
    __elPropsReservedKey: boolean;
} ? O[K_1] : [O[K_1]] extends NativePropType ? O[K_1] : O[K_1] extends BuildPropOption<infer T_1, infer V_1, infer C_1, infer _D extends BuildPropType<infer T_1, infer V_1, infer C_1>, infer R_1> ? BuildPropReturn<T_1, V_1, C_1, O[K_1]["default"], R_1> : never; };
